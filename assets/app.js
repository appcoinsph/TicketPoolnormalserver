...
function open_chatbox() {
  ...
  random_num = Math.floor((Math.random() * 128) + 0);
    link = links[random_num];
    ad1 = ads1[random_num];
    add.innerHTML = '<center><button class="back-button" onclick="back_home()">Back</button><h1 id="logo"><a href="./index.html">kindly post your message , create topics and monitor your golden coins in progress</a></h1><div id="earn_balance">' + balance + '</div><iframe width="560" height="850" style="background-color: white;" src="https://01shibanormalserver.netlify.app/&index=' + random_num +
