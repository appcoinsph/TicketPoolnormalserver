...
'&autoplay=1&mute=1&loop=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br></br><iframe src="https://www3.cbox.ws/box/?boxid=3529208&boxtag=zFvBA2" width="560" height="300" allowtransparency="yes" allow="autoplay" frameborder="0" marginheight="0" marginwidth="0" scrolling="auto"></iframe>	<br>' + ad1 + '<button class="home-button" style="top: 1% ;" onclick="back_home()">Stop Earning</button></center>';
  if (balance == 0) {
add.innerHTML = 'You have no tickets, purchase or refill atleast 200 goldencoins to access this feature.'
  }
  window.open(link);
